...
$nitropack_functions_file = '/homepages/41/d883667533/htdocs/aesthe/wp-content/plugins/nitropack/functions.php';
$nitropack_abspath = '/homepages/41/d883667533/htdocs/aesthe/';
...
if (file_exists($nitropack_functions_file) && ABSPATH == $nitropack_abspath) {
    ...
    define( 'NITROPACK_ADVANCED_CACHE_VERSION', '1.10.3');
    define( 'NITROPACK_LOGGED_IN_COOKIE', 'wordpress_logged_in_533cc22486f47d9366c98b756df61519' );
