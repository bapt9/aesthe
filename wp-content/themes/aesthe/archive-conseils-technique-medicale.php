...
/*
Template Name: Conseils techniques médicales
*/
...
<section class="blogMostRead wrapper">
    ...
    <div class="blogMostRead__posts">
        ...
        <?php
        $args = array(
            'post_type' => array('conseils-medicales'),
        ...
        ?>
                    <a class="blogMostRead__post" href="<?= get_the_permalink() ?>">
                        ...
                        <div class="blogMostRead__postTitle ">
                            <div class="blogMostRead__date date"><?php echo get_the_date('d.m.y'); ?></div>
                            <h4><?php the_title(); ?></h4>
                        </div>
                    </a>
            ...
            <a class="blogPosts__post" href="<?php the_permalink(); ?>">
                ...
                <div class="blogPosts__info">
                    <div class="blogPosts__postTitleDate">
                        <h4><?php the_title(); ?></h4>
                        <div class="blogPosts__date date"><?php echo get_the_date('d.m.y'); ?></div>
                    </div>
