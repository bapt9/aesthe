(function () {
  ...
  */
  ...
  (function ($, undefined$1) {
    ...
    function equal(a, b) {
      if (a === b) return true;
      if (a === undefined$1 || b === undefined$1) return false;
    ...
    function installKeyUpChangeEvent(element) {
      ...
      element.on("keydown", function () {
        if ($.data(element, key) === undefined$1) {
      ...
      element.on("keyup", function () {
        ...
        if (val !== undefined$1 && element.val() !== val) {
    ...
    function installFilteredMouseMove(element) {
      element.on("mousemove", function (e) {
        ...
        if (lastpos === undefined$1 || lastpos.x !== e.pageX || lastpos.y !== e.pageY) {
      ...
      return function (query) {
        ...
        timeout = window.setTimeout(function () {
          ...
          deprecated = {
            ...
            jsonpCallback: options.jsonpCallback || undefined$1,
      ...
      return function (query) {
        ...
        if ($.isArray(result)) {
          $(result).each(function () {
            var isObject = this.text !== undefined$1,
    ...
    function defaultTokenizer(input, selection, selectCallback, opts) {
      ...
      if (!opts.createSearchChoice || !opts.tokenSeparators || opts.tokenSeparators.length < 1) return undefined$1;
      ...
      while (true) {
        ...
        if (token.length > 0) {
          ...
          if (token !== undefined$1 && token !== null && opts.id(token) !== undefined$1 && opts.id(token) !== null) {
            dupe = false;
    ...
    AbstractSelect2 = clazz(Object, {
      ...
      init: function init(opts) {
        var results,
            search,
            resultsSelector = ".select2-results"; // prepare options

        this.opts = opts = this.prepareOpts(opts);
        this.id = opts.id; // destroy if called on an existing component

        if (opts.element.data("select2") !== undefined$1 && opts.element.data("select2") !== null) {
        ...
        this.nextSearchTerm = undefined$1;
        ...
        if (disabled === undefined$1) disabled = false;
        this.enable(!disabled);
        var readonly = opts.element.prop("readonly");
        if (readonly === undefined$1) readonly = false;
      ...
      prepareOpts: function prepareOpts(opts) {
        ...
        opts = $.extend({}, {
          populateResults: function populateResults(container, results, query) {
            ...
            _populate = function populate(results, container, depth) {
              ...
              results = opts.sortResults(results, container, query); // collect the created nodes for bulk append
              ...
              for (i = 0, l = results.length; i < l; i = i + 1) {
                ...
                selectable = !disabled && id(result) !== undefined$1;
        ...
        if (select) {
          opts.query = this.bind(function (query) {
            ...
            if (this.getPlaceholder() !== undefined$1 && children.length > 0) {
          ...
          if (!("query" in opts)) {
            if ("ajax" in opts) {
              ...
              if (opts.createSearchChoice === undefined$1) {
              ...
              if (opts.initSelection === undefined$1) {
      ...
      enable: function enable(enabled) {
        if (enabled === undefined$1) enabled = true;
      ...
      readonly: function readonly(enabled) {
        if (enabled === undefined$1) enabled = false;
      ...
      positionDropdown: function positionDropdown() {
        var $dropdown = this.dropdown,
          ...
          return offset.left + viewPortRight + container.outerWidth(false) > dropWidth;
            ...
            changeDirection,
            css,
            resultsListNode; // always prefer the current above/below alignment, unless there is not enough room
      ...
      open: function open() {
        ...
        this.opening(); // Only bind the document mousemove when the dropdown is visible
      ...
      close: function close() {
        ...
        this.results.empty(); // Now that the dropdown is closed, unbind the global document mousemove event
      ...
      ensureHighlightVisible: function ensureHighlightVisible() {
        ...
        hb = topOffset + child.outerHeight(true); // if this is the last child lets also make sure select2-more-results is visible
        ...
        y = topOffset - results.offset().top; // make sure the top of the element is visible
      ...
      highlight: function highlight(index) {
        ...
        choice.addClass("select2-highlighted"); // ensure assistive technology can determine the active choice
      ...
      updateResults: function updateResults(initial) {
        ...
        this.removeHighlight(); // give the tokenizer a chance to pre-process the input

        input = this.tokenize();

        if (input != undefined$1 && input != null) {
          search.val(input);
        }
        ...
        opts.query({
          ...
          callback: this.bind(function (data) {
            ...
            if (data.hasError !== undefined$1 && checkFormatter(opts.formatAjaxError, "formatAjaxError")) {
              render("<li class='select2-ajax-error'>" + evaluate(opts.formatAjaxError, opts.element, data.jqXHR, data.textStatus, data.errorThrown) + "</li>");
              return;
            } // save context, if any


            this.context = data.context === undefined$1 ? null : data.context; // create a default choice and prepend it to the list

            if (this.opts.createSearchChoice && search.val() !== "") {
              def = this.opts.createSearchChoice.call(self, search.val(), data.results);

              if (def !== undefined$1 && def !== null && self.id(def) !== undefined$1 && self.id(def) !== null) {
      ...
      getPlaceholder: function getPlaceholder() {
        ...
        this.opts.element.data("placeholder") || this.opts.placeholder || ((placeholderOption = this.getPlaceholderOption()) !== undefined$1 ? placeholderOption.text() : undefined$1);
      },
      // abstract
      getPlaceholderOption: function getPlaceholderOption() {
        if (this.select) {
          ...
          if (this.opts.placeholderOption !== undefined$1) {
    ...
    SingleSelect2 = clazz(AbstractSelect2, {
      ...
      opening: function opening() {
        ...
        if (this.search.val() === "") {
          if (this.nextSearchTerm != undefined$1) {
      ...
      initContainer: function initContainer() {
        ...
        this.focusser = container.find(".select2-focusser"); // add aria associations

        selection.find(".select2-chosen").attr("id", "select2-chosen-" + idSuffix);
        this.focusser.attr("aria-labelledby", "select2-chosen-" + idSuffix);
        this.results.attr("id", "select2-results-" + idSuffix);
        this.search.attr("aria-owns", "select2-results-" + idSuffix); // rewrite labels from original element to focusser
        ...
        this.focusser.prev().text(elementLabel.text()).attr('for', this.focusser.attr('id')); // Ensure the original element retains an accessible name

        var originalTitle = this.opts.element.attr("title");
        this.opts.element.attr("title", originalTitle || elementLabel.text());
        this.focusser.attr("tabindex", this.elementTabIndex); // write label for search field using the label from the focusser element

        this.search.attr("id", this.focusser.attr('id') + '_search');
        this.search.prev().text($("label[for='" + this.focusser.attr('id') + "']").text()).attr('for', this.search.attr('id'));
        this.search.on("keydown", this.bind(function (e) {
          if (!this.isInterfaceEnabled()) return; // filter 229 keyCodes (input method editor is processing key input)
      ...
      initSelection: function initSelection() {
        ...
        if (this.isPlaceholderOptionSelected()) {
          ...
          this.opts.initSelection.call(null, this.opts.element, function (selected) {
            if (selected !== undefined$1 && selected !== null) {
      ...
      isPlaceholderOptionSelected: function isPlaceholderOptionSelected() {
        var placeholderOption;
        if (this.getPlaceholder() === undefined$1) return false; // no placeholder specified so no option should be considered

        return (placeholderOption = this.getPlaceholderOption()) !== undefined$1 && placeholderOption.prop("selected") || this.opts.element.val() === "" || this.opts.element.val() === undefined$1 || this.opts.element.val() === null;
      },
      // single
      ...
      getPlaceholder: function getPlaceholder() {
        ...
        if (this.select) {
          if (this.getPlaceholderOption() === undefined$1) {
            return undefined$1;
          }
        }
      ...
      setPlaceholder: function setPlaceholder() {
        ...
        if (this.isPlaceholderOptionSelected() && placeholder !== undefined$1) {
          // check for a placeholder option if attached to a select
          if (this.select && this.getPlaceholderOption() === undefined$1) return;
   ...
   // find the selected element in the result list
      ...
      updateSelection: function updateSelection(data) {
        ...
        if (cssClass !== undefined$1) {
          container.addClass(cssClass);
        }

        this.selection.removeClass("select2-default");

        if (this.opts.allowClear && this.getPlaceholder() !== undefined$1) {
      ...
      val: function val() {
        ...
        if (this.select) {
          ...
          if (this.opts.initSelection === undefined$1) {
    ...
    MultiSelect2 = clazz(AbstractSelect2, {
      ...
      prepareOpts: function prepareOpts() {
        ...
        if (opts.element.get(0).tagName.toLowerCase() === "select") {
          ...
          // install default initSelection when applied to hidden input and data is local
          opts.initSelection = opts.initSelection || function (element, callback) {
            var ids = splitVal(element.val(), opts.separator, opts.transformVal); //search in data by array of ids, storing matching items in a list
      ...
      initContainer: function initContainer() {
        ...
        this.initContainerWidth();
        this.opts.element.hide(); // set the placeholder if necessary
      ...
      clearSearch: function clearSearch() {
        ...
        if (placeholder !== undefined$1 && this.getVal().length === 0 && this.search.hasClass("select2-focused") === false) {
      ...
      opening: function opening() {
        ...
        this.resizeSearch();
        this.parent.opening.apply(this, arguments);
        this.focusSearch(); // initializes search's value with nextSearchTerm (if defined by user)
        // ignore nextSearchTerm if the dropdown is opened by the user pressing a letter
      ...
      tokenize: function tokenize() {
        ...
        if (input != null && input != undefined$1) {
    ...
    $.fn.select2 = function () {
      ...
      return value === undefined$1 ? this : value;
    ...
    $.fn.select2.defaults = {
      ...
      formatSelection: function formatSelection(data, container, escapeMarkup) {
        return data ? escapeMarkup(this.text(data)) : undefined$1;
      },
      ...
      id: function id(e) {
        return e == undefined$1 ? null : e.id;
      },
