...
class Import extends AbstractCommand
{
    ...
    protected function displayResults(): void
    {
        ...
        $this->pass();
        $messages = [
            'imported' => sprintf(_x('%d imported', 'admin-text', 'site-reviews-forms'), $this->imported),
            'skipped' => sprintf(_x('%d skipped', 'admin-text', 'site-reviews-forms'), $this->skipped),
            'updated' => sprintf(_x('%d updated', 'admin-text', 'site-reviews-forms'), $this->updated),
        ];
