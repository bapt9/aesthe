...
class CustomTextareaTag extends Tag
{
    ...
    {
        $text = glsr(Text::class)->normalize($this->value);
    ...
    protected function value(): string
    {
        ...
        $method = Helper::buildMethodName('formatAs', $format);
    ...
    protected function valueAsExcerpt(): string
    {
        ...
        return glsr_get_option('reviews.excerpts', false, 'bool')
            ? glsr(Text::class)->excerpt($this->value, $limit)
            : glsr(Text::class)->text($this->value);
    }
